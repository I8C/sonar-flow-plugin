...
/**
 * This visitor counts the lines of flow code 
 * (SEQUENCE, INVOKE, BRANCH, MAP, LOOP and EXIT)
 * and stores it in the metric that is given on initialization.
 * 
 * @author DEWANST
 *
 * @param <G>
 ...
 */
public class FlowLinesOfCodeVisitor<G extends Grammar> extends FlowVisitor<G> {
  ...
  @Override
  public void init() {
    subscribeTo(FlowGrammar.SEQUENCE, FlowGrammar.INVOKE, FlowGrammar.BRANCH, FlowGrammar.MAP,
        FlowGrammar.LOOP, FlowGrammar.EXIT);
  }
