...
/**
 * This visitor counts the individual flow components 
 * (SEQUENCE, INVOKE, BRANCH, MAP, LOOP and EXIT)
 * and stores it in their corresponding FlowMetric.
 * 
 * @author DEWANST
 *
 * @param <G>
 ...
 */
public class SimpleMetricVisitor extends FlowVisitor<Grammar> {
  @Override
  public void init() {
    subscribeTo(FlowGrammar.INVOKE, FlowGrammar.MAP, FlowGrammar.SEQUENCE, FlowGrammar.LOOP,
        FlowGrammar.COMMENT);
  }
