...
public class NodeAstScannerTest {
	...
	@Test
	  public void scanFile() {
		...
		NodeAstScanner.scanSingleFile(new File("src/test/resources/WmPackage/ns/WmPackage/flows/testFlow/node.ndf"));
	}
	
	@Test
	  public void savePipelineCheck() {
		NodeAstScanner.scanSingleFile(new File("src/test/resources/WmPackage/ns/WmPackage/flows/testFlow/node.ndf"), new InterfaceCommentsCheck());
	}
}
